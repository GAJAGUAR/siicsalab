...
@section('formContent')
  ...
  @component('components.inputs.form_row')
    ...
    @component('components.inputs.text')
      ...
      @slot('value', $sample->road_station_start)
    ...
    @component('components.inputs.text')
      ...
      @slot('value', $sample->road_station_end)
    ...
    @component('components.inputs.text')
      ...
      @slot('value', $sample->road_station)
